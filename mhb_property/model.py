...
class PropertyProject(models.Model):
    ...
    type=fields.Selection([('Housing Society','Housing Society'),('Appartments','Appartments'),('Rent','Rent')],required=1)
...
class Plots(models.Model):
    ...
    facing=fields.Selection([('West','West'),('East','East')],default='West')
